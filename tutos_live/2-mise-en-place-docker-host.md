...
### ✅ La Solution
Éditez le fichier `/etc/network/interfaces` sur l'hôte Proxmox. Ajoutez ces règles dans la section de votre pont privé `vmbr1` (after the existing Masquerading rules):
