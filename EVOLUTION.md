...
- Configuration du Masquerading (NAT) sur `vmbr1` for l'isolation des LXC. (Voir [Tuto 1](https://kpihx-labs.github.io/presentation/#/tutos_live/1-deploiement-proxmox-8021x.md))
